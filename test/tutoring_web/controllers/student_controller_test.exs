defmodule TutoringWeb.StudentControllerTest do
  use TutoringWeb.ConnCase

  alias Tutoring.Classes

  @create_attrs %{day: "some day", email: "some email", grade: 42, name: "some name", phone: "some phone", time: ~T[14:00:00.000000]}
